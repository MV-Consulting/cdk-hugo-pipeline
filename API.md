...
### HugoRepository <a name="HugoRepository" id="cdk-hugo-pipeline.HugoRepository"></a>

#### Initializers <a name="Initializers" id="cdk-hugo-pipeline.HugoRepository.Initializer"></a>

```typescript
import { HugoRepository } from 'cdk-hugo-pipeline'

new HugoRepository(scope: Construct, id: string, props: HugoRepositoryProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.Initializer.parameter.props">props</a></code> | <code><a href="#cdk-hugo-pipeline.HugoRepositoryProps">HugoRepositoryProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="cdk-hugo-pipeline.HugoRepository.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="cdk-hugo-pipeline.HugoRepository.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="cdk-hugo-pipeline.HugoRepository.Initializer.parameter.props"></a>

- *Type:* <a href="#cdk-hugo-pipeline.HugoRepositoryProps">HugoRepositoryProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.toString">toString</a></code> | Returns a string representation of this construct. |

---

##### `toString` <a name="toString" id="cdk-hugo-pipeline.HugoRepository.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="cdk-hugo-pipeline.HugoRepository.isConstruct"></a>

```typescript
import { HugoRepository } from 'cdk-hugo-pipeline'

HugoRepository.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="cdk-hugo-pipeline.HugoRepository.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-hugo-pipeline.HugoRepository.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |

---

##### `node`<sup>Required</sup> <a name="node" id="cdk-hugo-pipeline.HugoRepository.property.node"></a>
...
### HugoRepositoryProps <a name="HugoRepositoryProps" id="cdk-hugo-pipeline.HugoRepositoryProps"></a>

#### Initializer <a name="Initializer" id="cdk-hugo-pipeline.HugoRepositoryProps.Initializer"></a>

```typescript
import { HugoRepositoryProps } from 'cdk-hugo-pipeline'

const hugoRepositoryProps: HugoRepositoryProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-hugo-pipeline.HugoRepositoryProps.property.name">name</a></code> | <code>string</code> | Name of the repository. |

---

##### `name`<sup>Optional</sup> <a name="name" id="cdk-hugo-pipeline.HugoRepositoryProps.property.name"></a>
